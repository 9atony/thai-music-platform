// src/components/Navbar.jsx (ฉบับสมบูรณ์: ใช้แทนของเดิม)
...
export default function Navbar() {
  ...
  const fetchUserData = async () => {
    try {
      // ดึง User ทั้งหมดมาเช็ค (หรือใช้ API user profile โดยตรงถ้ามี)
  ...
  // เช็คว่าอยู่หน้า Editor หรือไม่ (ถ้าใช่จะเปลี่ยนธีมเป็นสีเข้ม)
