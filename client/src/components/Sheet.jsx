// src/components/Sheet.jsx (ฉบับแก้ไข: รับและแสดง Playback Highlight)
import React from 'react';

// ✅ รับ Prop ใหม่: playbackCells
const Sheet = ({ data, rowTypes, selectedCell, onCellClick, metaData, onMetaChange, currentFont, playbackCells = [] }) => {
  ...
  // 💡 NEW: ฟังก์ชันเช็ค Highlight การเล่น
    ...
    return (
      <div className={gridClass}>
        ...
        {rowData.map((cellData, colIndex) => {
          ...
          // 💡 NEW: ตรวจสอบว่า Cell นี้ถูก Highlight ในโหมดเล่นเพลงหรือไม่
          ...
          return (
            <div 
              ...
              className={`
                ...
                ${isPlaying ? 'bg-yellow-100/70 border-yellow-400 ring-2 ring-yellow-400 z-20' : ''} /* 🎯 FIX: Highlight Class */
                h-10 
              `}
            >
              <span className={`
